...
<body>
    ...
    <script>
        function doRegister() {
            ...
            fetch('/Cop4710_Project/Cop4710_Project/WAMPAPI/formhandler.php', {
                method: 'POST',
                headers: {
            ...
            .then(data => {
                ...
                try {
                    ...
                    if (jsonData.success === false) {
                        ...
                        $(registerResult).append("<p>Registration successful. Redirecting to login page...</p>");
                        setTimeout(() => {
                            window.location.href = "index.html"; // Always redirect to index.html
                        }, 1500);
                    }
                } catch (e) {
